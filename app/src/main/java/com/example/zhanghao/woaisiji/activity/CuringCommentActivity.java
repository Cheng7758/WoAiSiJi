...
public class CuringCommentActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        //网络请求
        StringRequest stringRequest=new StringRequest(Request.Method.POST, ServerAddress.URL_CURING_DETAILS, new Response.Listener<String>() {
            @Override
    ...
    class CommentAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null){
                ...
                convertView= LayoutInflater.from(CuringCommentActivity.this).inflate(R.layout.productdetail_itme_comment,null);
