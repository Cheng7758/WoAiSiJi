...
public class SliverStoreAdapter extends BaseAdapter {
    TextView textView;
    private final Context mContext;
    private final List<FBHStoreCategory> mListData;
   // private int selectPos;
    ...
    public SliverStoreAdapter(Context context, List<FBHStoreCategory> listData) {
        mContext = context;
        mListData = listData;
    }
