...
public class SliverStoreDataDetailAdapter extends BaseQuickAdapter<RespCommodityList.CommodityDataDetail, FBHStoreDataDetailHolder> {

    private Activity context;

    public SliverStoreDataDetailAdapter(Activity activity, List<RespCommodityList.CommodityDataDetail> data) {
