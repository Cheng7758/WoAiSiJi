...
public abstract class DriverReviewHolder extends RecyclerView.ViewHolder implements VideoLoadMvpView {
...
//    public TextView urlTipTv;
    ...
    public DriverReviewHolder(View itemView, int viewType) {
        super(itemView);
