 ...
 */
public class CategoryGoodDetailPager extends BasePagerDetail implements PullToRefreshLayout.OnRefreshListener{
    ...
    public CategoryGoodDetailPager(Activity activity, int pid,int type) {
        super(activity);
        this.pid = pid;
        this.type = type;
