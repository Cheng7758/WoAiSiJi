 ...
 */
public class NewMemberDetailPager extends BasePagerDetail implements PullToRefreshLayout.OnRefreshListener{

    private static final int MEMBER_INFO = 0;
    private static final int ADDRESS_INFO = 1;
    private BaseListView lvSocialNewMember;
    ...
    public NewMemberDetailPager(Activity activity,int type) {
        super(activity);
        this.type = type;
    }
    ...
    public View initView() {
        View view = View.inflate(mActivity, R.layout.social_pager_new_member_detail, null);
        lvSocialNewMember = (BaseListView) view.findViewById(R.id.lv_social_new_member);
    ...
    private void getDataFromServer() {
        ...
        StringRequest stickyRequest = new StringRequest(Request.Method.POST, ServerAddress.URL_DRIVER_SOCIAL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                transServerData(response,MEMBER_INFO);
                if (socialPagerSticky.code == 200) {
                    if (socialPagerSticky.list != null) {
                        ...
                        if (isFirst){
                            isFirst = false;
                            lvSocialNewMember.setAdapter(memberInfoListAdapter);
                        }else {
                            memberInfoListAdapter.notifyDataSetChanged();
                        }
                    }else {
                        Toast.makeText(mActivity,"数据已经加载完了!",Toast.LENGTH_SHORT).show();
                    }
                }
            }
    ...
    class MemberInfoListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = View.inflate(mActivity, R.layout.social_member_list_item, null);
