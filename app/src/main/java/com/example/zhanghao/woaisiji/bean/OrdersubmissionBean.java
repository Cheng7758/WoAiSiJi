...
public class OrdersubmissionBean {
     ...
     * msg : 订单生成成功!
     * ordernum : 1477045807
     * post : {"beuzhu":"","car_rmb":["0","0"],"goods_f_silver":["392","392"],"goods_f_sorts":["0","0"],"goods_id":["257","256"],"goods_max":["97","97"],"goods_name":["爱孚威三元催化器清洗剂三元催化清洗剂排放达标节省燃油","爱孚威喷油嘴清洗剂有效清除喷油嘴积碳减少爱车积碳增强动力"],"goods_num":["1","1"],"goods_price":["98","98"],"plcid":"41","user_id":"3"}
     */
     ...
     * beuzhu :
     * car_rmb : ["0","0"]
     * goods_f_silver : ["392","392"]
     * goods_f_sorts : ["0","0"]
     * goods_id : ["257","256"]
     * goods_max : ["97","97"]
     * goods_name : ["爱孚威三元催化器清洗剂三元催化清洗剂排放达标节省燃油","爱孚威喷油嘴清洗剂有效清除喷油嘴积碳减少爱车积碳增强动力"]
     * goods_num : ["1","1"]
     * goods_price : ["98","98"]
     * plcid : 41
     * user_id : 3
