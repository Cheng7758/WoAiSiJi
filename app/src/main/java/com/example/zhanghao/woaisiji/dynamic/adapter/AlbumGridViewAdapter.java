...
public class AlbumGridViewAdapter extends BaseAdapter{
	...
	private ArrayList<DynamicImageBean> selectedDataList;
	private DisplayMetrics dm;
	BitmapCache cache;
	public AlbumGridViewAdapter(Context c, ArrayList<DynamicImageBean> dataList,
			ArrayList<DynamicImageBean> selectedDataList) {
		mContext = c;
...
//					path, Res.getDrawableID("plugin_camera_camera_default"), 100, 100);
			final DynamicImageBean item = dataList.get(position);
