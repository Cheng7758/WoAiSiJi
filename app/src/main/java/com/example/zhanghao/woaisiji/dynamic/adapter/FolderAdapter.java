package com.example.zhanghao.woaisiji.dynamic.adapter;
...
import com.example.zhanghao.woaisiji.dynamic.ShowAllPhotoActivity;
import com.example.zhanghao.woaisiji.dynamic.bean.DynamicImageBean;
import com.example.zhanghao.woaisiji.dynamic.util.BitmapCache;
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
			final DynamicImageBean item = AlbumActivity.contentList.get(position).imageList.get(0);
	...
	private class ImageViewClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			ShowAllPhotoActivity.dataList = (ArrayList<DynamicImageBean>) AlbumActivity.contentList.get(position).imageList;
