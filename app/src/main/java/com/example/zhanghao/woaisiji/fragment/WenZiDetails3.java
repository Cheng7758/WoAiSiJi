...
public class WenZiDetails3 extends Fragment implements ViewPager.OnPageChangeListener {
    //储存请求地址
    ...
    @SuppressLint("ValidFragment")
    public WenZiDetails3(Context context, DetailsBean detailsBean) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        diya.setText("金币可抵" + detailsBean.getInfo().getMaxchit());
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerAddress.URL_PRODUCTPICTURE, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (productPicture.getCode() == 200) {
                    ...
                    imageAdapter = new ImageAdapter(PictureUrl, getActivity());
                    viewPager.setAdapter(imageAdapter);
                    viewPager.setOnPageChangeListener(WenZiDetails3.this);
                }
            }
