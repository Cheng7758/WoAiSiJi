package com.example.zhanghao.woaisiji.mvp.contract;
 ...
 */
public interface DriverReviewContract {

    interface View extends BaseView{
        void update2DeleteDriverReview(String circleId);
    ...
    interface Presenter extends BasePresenter{
        ...
        void deleteDriverReview(final String circleId);
