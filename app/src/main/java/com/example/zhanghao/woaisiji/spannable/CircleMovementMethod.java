package com.example.zhanghao.woaisiji.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = WoAiSiJiApp.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = WoAiSiJiApp.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
