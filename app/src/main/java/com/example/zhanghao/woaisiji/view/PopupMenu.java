...
//		this.tabs = tabs;
	...
	public void onClick(View v) {
		...
		if (v == v_item1) {
			...
			activity.startActivity(new Intent(activity, PersonalFriendsMessageActivity.class));
//			str = tabs[0];
//			TextView tvAboutUs = (TextView)v_item1.findViewById(R.id.tv_msg_notice);
...
//			str = tabs[1];
//			TextView tvAboutUs = (TextView)v_item2.findViewById(R.id.tv_add_friend);
//			tvAboutUs.setText(str);
//		} else if (v == v_item3) {
